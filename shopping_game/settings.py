"""
Django settings for shopping_game project.
...
# SECURITY WARNING: set SECRET_KEY via the SECRET_KEY environment variable in production!
...
ROOT_URLCONF = 'shopping_game.urls'
...
WSGI_APPLICATION = 'shopping_game.wsgi.application'
